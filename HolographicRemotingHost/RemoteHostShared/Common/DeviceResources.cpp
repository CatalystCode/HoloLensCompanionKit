...
void DX::DeviceResources::SetD3DDevice(ID3D11Device4 * pDevice)
{
	m_d3dDevice = pDevice;
}
...
//    }
	...
	// Store a reference to the immediate device context.
	m_d3dDevice->GetImmediateContext3(m_d3dContext.GetAddressOf());
